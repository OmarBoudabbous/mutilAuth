...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('backendAdmin/assets/vendors/flatpickr/flatpickr.min.css') }}">
...
<body>
    <div class="main-wrapper">
        ...
        @include('role.admin.layout.sidebar')
        ...
        <div class="page-wrapper">
            ...
            @include('role.admin.layout.header')
            <!-- partial -->
            ...
            @include('role.admin.layout.footer')
            <!-- partial -->
    ...
    <script src="{{ asset('backendAdmin/assets/vendors/flatpickr/flatpickr.min.js') }}"></script>
    <script src="{{ asset('backendAdmin/assets/vendors/apexcharts/apexcharts.min.js') }}"></script>
    ...
    <script src="{{ asset('backendAdmin/assets/js/dashboard-dark.js') }}"></script>
